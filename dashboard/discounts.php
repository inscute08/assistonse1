		...
		<div class="container-fluid">
			...
			<aside class="col p-5 pt-0">
				...
				<ul id="nav_side" class="nav flex-column">                    
					...
					<li class="nav-item mt-5">
						<a class="nav-link text-light custom_active" href="./discounts">Discounts</a>
					</li>
			...
			<div id="main_content" class="row m-0 pt-3 pb-5">
				<div class="col-12 col-lg-7 text-center p-3 pt-0">
					<article id="main_cont_container" class="border border-light rounded-3 p-3 text-start">
						<h1 class="fs-3 custom_active">Discounts</h1>
						<table id="table" class="table text-light text-center align-middle m-0">
							...
							<tbody>
								<?php
									...
									$rows = $model->fetchInfo('discounts');
					...
					<div class="d-block mb-2">
						<a target="" class="button btn btn-dark px-5 border-1 border-light" href="" data-bs-toggle="modal" data-bs-target="#modal">Add discount</a>
					</div>
							...
							<div class="modal-content">
								...
								<form method="POST">
									...
									<div class="modal-footer pt-0 pb-5 border-0 d-flex justify-content-center">
										<button type="submit" class="btn btn-dark py-1 px-4 border-light" name="add">Add discount</button>
									</div>
								</form>
							</div>
						</div>
					...
					<?php
						...
						if (isset($_POST['add'])) {
							...
							$model->addInfo('discounts', $info);

							echo "<script>window.open('discounts', '_self');</script>";
						}
						...
						<div id="summary_contents" class="p-3">
							<div class="dropdown">
								<button id="main_dropdown" class="btn btn-light dropdown-toggle d-block w-100" type="button">
								  Discounts <a href="#" id="down_arrow" class="text-center"><i class="bi bi-chevron-down"></i></a>
								</button>
