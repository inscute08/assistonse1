		...
		<div class="container-fluid">
			...
			<div id="brgy_buttons" class="row m-0 pt-3 pe-0 pe-md-3 rounded-3">
				<div class="col-12 col-md-4 fs-6 mb-3 mb-md-0">
					<a class="btn btn-dark py-0 px-1 border-light custom_active" id="archive" href="./archive_activities">See Archive</a>
				...
				<div class="table-responsive">
								...
								?>
									...
									<td>
										<ul class="list-unstyled">
											...
											<li><a href="#" data-id="2" class="remove text-light text-decoration-none" data-bs-toggle="modal" data-bs-target="#update_status-<?php echo $row['control_no']; ?>">Restore</a></li>
										</ul>
									</td>
								</tr>
									...
									<div class="modal-dialog modal-dialog-centered">
										<div class="modal-content">
											<div class="modal-header d-flex justify-content-start">
												...
												<h5 class="modal-title">Restore activity</h5>
											</div>
											<form method="POST">
								...
								<?php 
									...
									if (isset($_POST['restore'])) {
										...
										echo "<script>window.open('archive_activities', '_self');</script>";
									}
