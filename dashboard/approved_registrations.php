	...
	<body>
			...
			<aside class="col p-5 pt-0">
				...
				<ul id="nav_side" class="nav flex-column">
					...
					<li class="nav-item mt-5">
						...
						<li class="nav-item">
							<small><a class="nav-link text-light custom_active" href="./approved_registrations">Pending</a></small>
						</li>

						<li class="nav-item">
							<small><a class="nav-link text-light" href="./declined_registrations">Declined</a></small>
						</li>
						...
						<table id="table" class="table text-light text-center align-middle m-0">
							...
							<tbody>
								<?php
									...
									$rows = $model->fetchPendingAccounts();
								...
								<?php 
									...
									if (isset($_POST['delete'])) {
										...
										$model->updateStatus($delete_id, 3);
		...
		<?php
			...
			if (isset($_POST['add-user'])) {
				...
				$model->register($senior_id, $first_name, $middle_name, $last_name, $senior_status, $gender, $contact, $landline, $civil_status, $birthdate, $address, $email, $user_id, $password, $guardian_name, $guardian_contact, $guardian_landline);
			}
