	...
	<body>
		<div class="container-fluid">
			...
			<div class="col-12 col-md-4 fs-6 mb-3 mb-md-0">
				<a class="btn btn-dark py-0 px-1 border-light" href="./archive_req_assist" id="archive">See Archive</a>
					...
					<table class="table text-light text-center align-middle m-0">
						...
						<tbody>
							<!-- <tr class="display1">
								...
								<td class="p-3">
									<ul class="list-unstyled">
										...
										<li><a href="#" class="text-light text-decoration-none">Decline</a></li>
							...
							<tr class="display1">
								...
								<th class="p-3" scope="row"><?php echo date('m/d/Y', strtotime($row['request_date'])); ?></th>
								<th class="p-3" scope="row"><?php echo date('g:ia', strtotime($row['request_date'])); ?></th>
								...
								<td class="p-3"><?php echo $row['request_type']; ?></td>
								<td class="p-3"><?php echo $row['request_details']; ?></td>
								<td class="p-3">
									<ul class="list-unstyled">
										<li><a href="#" class="text-light text-decoration-none" data-bs-toggle="modal" data-bs-target="#modal">Approve</a></li>
										<li><a href="#" class="text-light text-decoration-none">Decline</a></li>
										<li><a href="#" class="text-light text-decoration-none" data-bs-toggle="modal" data-bs-target="#modal_forward">Forward</a></li>
										<li><a href="#" data-id="1" class="remove text-light text-decoration-none" data-bs-toggle="modal" data-bs-target="#remove-<?php echo $row['id']; ?>">Remove</a></li>
									</ul>
								</td>
							</tr>
									...
									<div class="modal-content">
										...
										<form method="POST">
											<div class="modal-body text-center mt-4">
												...
												<div class="form-group mb-3">
													<label class="d-block mb-2">Request</label>
													<input type="text" class="form-control rounded-0" value="<?php echo $row['request_type']; ?>" readonly>
												</div>
												<div class="form-group mb-3">
													<label class="d-block mb-2">Purpose</label>
													<input type="text" class="form-control rounded-0" value="<?php echo $row['request_details']; ?>" readonly>
												</div>
												<div class="form-group mb-3">
													<label class="d-block mb-2">Request Date</label>
													<input type="text" class="form-control rounded-0" value="<?php echo date('m/d/Y g:ia', strtotime($row['request_date'])); ?>" readonly>
												</div>
											</div>
											<div class="modal-footer pt-0 pb-5 border-0 d-flex justify-content-center">
												<button type="submit" class="btn btn-dark py-1 px-4 border-light" name="remove">Remove</button>
											</div>
										</form>
									</div>
								</div>
							...
							<?php
								...
								if (isset($_POST['remove'])) {
									...
									$model->updateRequestStatus($remove_id, $status);

									echo "<script>window.open('req_assist', '_self');</script>";
								}
