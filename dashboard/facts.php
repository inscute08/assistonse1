		...
		<div class="container-fluid">
			...
			<aside class="col p-5 pt-0">
				...
				<ul id="nav_side" class="nav flex-column">                    
					...
					<li class="nav-item mt-5">
						<a class="nav-link text-light custom_active" href="./facts">Facts</a>
					</li>
			...
			<div id="main_content" class="row m-0 pt-3 pb-5">
				<div class="col-12 col-lg-7 text-center p-3 pt-0">
					<article id="main_cont_container" class="border border-light rounded-3 p-3 text-start">
						<h1 class="fs-3 custom_active">Facts</h1>
					...
					<div class="d-block mb-2">
						<a target="" class="button btn btn-dark px-5 border-1 border-light" href="" data-bs-toggle="modal" data-bs-target="#modal">Add fact</a>
					</div>
						...
						<div class="modal-dialog modal-dialog-centered">
							<div class="modal-content">
								<div class="modal-header d-flex justify-content-start">
									...
									<h5 class="modal-title">Add fact</h5>
								</div>
								<form method="POST">
									...
									<div class="modal-footer pt-0 pb-5 border-0 d-flex justify-content-center">
										<button type="submit" class="btn btn-dark py-1 px-4 border-light" name="add">Add fact</button>
									</div>
								</form>
							</div>
						</div>
					...
					<?php
						...
						if (isset($_POST['add'])) {
							...
							$model->addInfo('facts', $info);

							echo "<script>window.open('facts', '_self');</script>";
						}
						...
						<div id="summary_contents" class="p-3">
							<div class="dropdown">
								<button id="main_dropdown" class="btn btn-light dropdown-toggle d-block w-100" type="button">
								  Facts <a href="#" id="down_arrow" class="text-center"><i class="bi bi-chevron-down"></i></a>
								</button>
